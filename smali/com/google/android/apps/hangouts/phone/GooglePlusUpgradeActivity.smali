...
.method public constructor <init>()V
    ...
    iget-object v1, p0, Lcom/google/android/apps/hangouts/phone/GooglePlusUpgradeActivity;->l:Lhbz;

    invoke-direct {v0, p0, v1}, Lgfk;-><init>(Landroid/app/Activity;Lhbb;)V

    iget-object v1, p0, Lcom/google/android/apps/hangouts/phone/GooglePlusUpgradeActivity;->k:Lgyn;

    .line 33
    invoke-virtual {v0, v1}, Lgfk;->a(Lgyn;)Lgfk;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/hangouts/phone/GooglePlusUpgradeActivity;->j:Lgeu;
...
.method private i()V
    ...
    .prologue
    .line 107
    iget-object v0, p0, Lcom/google/android/apps/hangouts/phone/GooglePlusUpgradeActivity;->j:Lgeu;

    invoke-interface {v0}, Lgeu;->a()I
    ...
    .line 108
    invoke-virtual {v0}, Lanh;->a()Ljava/lang/String;

    move-result-object v0

    .line 109
    invoke-static {v0}, Lelb;->a(Ljava/lang/String;)Landroid/content/Intent;
...
.method protected onActivityResult(IILandroid/content/Intent;)V
    ...
    iget-object v3, p0, Lcom/google/android/apps/hangouts/phone/GooglePlusUpgradeActivity;->j:Lgeu;

    .line 119
    invoke-interface {v3}, Lgeu;->c()Lgez;

    move-result-object v3

    const-string v4, "account_name"

    invoke-interface {v3, v4}, Lgez;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 123
    invoke-virtual {p0}, Lcom/google/android/apps/hangouts/phone/GooglePlusUpgradeActivity;->getBinder()Lgyn;

    move-result-object v0

    const-class v2, Lgey;

    invoke-virtual {v0, v2}, Lgyn;->a(Ljava/lang/Class;)Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lgey;

    iget-object v2, p0, Lcom/google/android/apps/hangouts/phone/GooglePlusUpgradeActivity;->j:Lgeu;

    invoke-interface {v2}, Lgeu;->a()I

    move-result v2

    invoke-interface {v0, v2}, Lgey;->b(I)Lgfb;
    ...
    .line 124
    invoke-interface {v0, v2, v5}, Lgfb;->c(Ljava/lang/String;Z)Lgfb;

    move-result-object v0

    .line 125
    invoke-interface {v0}, Lgfb;->d()I
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    invoke-direct {v0, p0}, Lcns;-><init>(Lcom/google/android/apps/hangouts/phone/GooglePlusUpgradeActivity;)V
